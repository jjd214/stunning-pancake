                    ...
                    <form action="{{ route('product.update', $product->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="product_name" name="name" type="text" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-900 dark:text-gray-100" value="{{ old('name', $product->name) }}" />
                            @error('name')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="product_description" name="description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-900 dark:text-gray-100">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="product_price" name="price" type="number" step="0.01" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-900 dark:text-gray-100" value="{{ old('price', $product->price) }}" />
                            @error('price')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="product_stock" name="stock" type="number" min="0" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-900 dark:text-gray-100" value="{{ old('stock', $product->stock) }}" />
                            @error('stock')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
